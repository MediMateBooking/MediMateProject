...
router.get("/patient/changePassword/:id", async (req, res) => {
  try {
    ...
    res.render("Patient/changePassword", { currentPatient: currentPatient, DOB : DOB, address:address}); //render the patientDashboard.ejs file. render keyword is used to render the ejs file
  } catch (error) {
